...
var UserRepository = /** @class */ (function (_super) {
    ...
    function UserRepository(db) {
        return _super.call(this, db, 'user_profile') || this;
    }
    /**
     * Retrieves the current user profile.
     * Since this is a personal app, we assume there's only one user (ID 'current_user').
     */
    UserRepository.prototype.getProfile = function () {
        return __awaiter(this, void 0, void 0, function () {
            var sql, results;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        sql = "SELECT * FROM ".concat(this.tableName, " LIMIT 1");
     ...
     */
    UserRepository.prototype.saveProfile = function (profile) {
        return __awaiter(this, void 0, void 0, function () {
            var existing;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        existing = _a.sent();
                        if (existing) {
                            return [2 /*return*/, this.update(existing.id, profile)];
                        }
                        else {
                            return [2 /*return*/, this.create(profile)];
                        }
                        return [2 /*return*/];
                }
            });
     ...
     */
    UserRepository.prototype.updateAvatar = function (path) {
        return __awaiter(this, void 0, void 0, function () {
            var profile;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.update(profile.id, {
                                foto_path: path,
